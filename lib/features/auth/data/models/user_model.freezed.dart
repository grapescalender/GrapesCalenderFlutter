...
class _$AuthResponseImpl implements _AuthResponse {
  ...
  @override
  String toString() {
    return 'AuthResponse(accessToken: $accessToken, refreshToken: $refreshToken, user: $user, message: $message)';
  }
...
class _$SignUpRequestImpl implements _SignUpRequest {
  ...
  @override
  String toString() {
    return 'SignUpRequest(username: $username, email: $email, password: $password, firstName: $firstName, lastName: $lastName, phoneNumber: $phoneNumber, farmName: $farmName)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, username, email, password,
      firstName, lastName, phoneNumber, farmName);
...
abstract class _SignUpRequest implements SignUpRequest {
  const factory _SignUpRequest(
      ...
      required final String lastName,
      required final String phoneNumber,
      final String farmName}) = _$SignUpRequestImpl;
